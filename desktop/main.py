...
print(resource_path(r'Images/1.png'))
...
class TitleScreen(Screen):
    source_down = resource_path(r'Images/down.png')
...
class MeteoValdayApp(App):
    def build(self):
        self.icon = resource_path('iconka.png')
        return Builder.load_file(resource_path('kivy.kv'))
